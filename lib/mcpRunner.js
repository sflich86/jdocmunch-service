    ...
    return new Promise((resolve, reject) => {
        ...
        const child = spawn('uvx', spawnArgs, {
            env: {
                ...
                JDOCMUNCH_EMBEDDING_PROVIDER: process.env.JDOCMUNCH_EMBEDDING_PROVIDER || 'gemini',
                GEMINI_EMBEDDING_MODEL: process.env.GEMINI_EMBEDDING_MODEL || 'models/gemini-embedding-2-preview',
