...
async function getClient() {
    ...
    mcpEnv.JDOCMUNCH_EMBEDDING_PROVIDER = mcpEnv.JDOCMUNCH_EMBEDDING_PROVIDER || "gemini";
    mcpEnv.GEMINI_EMBEDDING_MODEL = mcpEnv.GEMINI_EMBEDDING_MODEL || "models/gemini-embedding-2-preview";
